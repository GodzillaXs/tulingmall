...
import com.tulingxueyuan.mall.domain.AdminDetails;
...
public class UmsAdminServiceImpl extends ServiceImpl<UmsAdminMapper, UmsAdmin> implements UmsAdminService {
    ...
    @Override
    public UserDetails loadUserByUsernameF(String username) {
        UmsAdmin umsAdmin = getAdminByUsername(username);
        if (umsAdmin!=null){
            return new AdminDetails(getRoleList(umsAdmin.getId()),umsAdmin);
        }
